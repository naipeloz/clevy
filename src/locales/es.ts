...
export const es = {
  ...
  admin: {
    ...
    overview: {
      ...
      statOpenJobs: "Búsquedas activas",
      statCandidates: "Candidatos",
      statApplications: "Aplicaciones",
      recentSearches: "Búsquedas recientes",
      activity: "Actividad reciente",
      applicants: "candidatos",
      emptyActivity: "Sin actividad todavía.",
    },
    companies: {
      eyebrow: "Empresas",
      title: "Empresas.",
      thCompany: "Empresa",
      thIndustry: "Industria",
      thSearches: "Búsquedas",
      thCulture: "Perfil cultural",
      cultureComplete: "Completo",
      culturePending: "Pendiente",
      view: "Editar",
    ...
    searches: {
      ...
      form: {
        ...
        descriptionHint: "Soporta Markdown: **negrita**, *itálica*, listas, enlaces.",
        location: "Ubicación",
        remote: "Remoto",
      ...
      candidates: {
        title: "Candidatos",
        subtitle: "Gestioná los candidatos de esta búsqueda y su estado.",
        addButton: "Agregar candidatos",
        approve: "Aprobar",
        remove: "Quitar",
        empty: "Todavía no hay candidatos en esta búsqueda.",
        cv: "CV",
        noCulture: "Sin evaluación cultural",
        modalTitle: "Agregar candidatos",
        search: "Buscar por nombre o email…",
        addSelected: "Agregar seleccionados",
        cancel: "Cancelar",
        noResults: "No hay candidatos disponibles.",
        stages: {
          self_applied: "Autoaplicó",
          presented_by_admin: "Presentado por admin",
          approved_by_clevy: "Aprobado por Clevy",
          suggested_by_ai: "Sugerido por IA",
          pending_cultural_match: "Pendiente match cultural",
        },
      },
    },
    users: {
  ...
  publicJobs: {
    eyebrow: "Búsquedas públicas",
    open: "abiertas",
    title: "Encontrá dónde aplicar.",
    subtitle:
      "Explorá las búsquedas abiertas de todas las empresas y postulate en un minuto.",
    signIn: "Iniciar sesión",
    empty: "Todavía no hay búsquedas públicas abiertas.",
    remote: "Remoto",
    apply: "Aplicar",
    viewDetail: "Ver búsqueda",
    back: "Volver a búsquedas",
    aboutRole: "Sobre la búsqueda",
    applyTitle: "Postulate a esta búsqueda",
    applySubtitle: "Dejanos tus datos y la empresa recibirá tu postulación.",
    fieldName: "Nombre completo",
    fieldEmail: "Email",
    fieldLinkedin: "LinkedIn (opcional)",
    fieldCv: "Link a tu CV (opcional)",
    fieldMessage: "Mensaje (opcional)",
    submit: "Enviar postulación",
    success: "¡Postulación enviada! La empresa la verá en su pipeline.",
    already: "Ya te habías postulado a esta búsqueda.",
  ...
  empresa: {
    ...
    home: {
      ...
      tabDraft: "Borradores",
      tabClosed: "Cerradas",
      statApplicants: "Candidatos",
      statAvgMatch: "Match prom.",
      statNew: "Nuevos",
